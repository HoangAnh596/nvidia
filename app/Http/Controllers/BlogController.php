...
class BlogController extends Controller
{
    ...
    public function blog()
    {
        ...
        return view('cntt.home.blog', compact('cate', 'news', 'viewer', 'outstand', 'newAll'));
    }
    ...
    public function cateBlog($slug)
    {
        ...
        return view('cntt.home.cateBlog', compact('cate', 'titleCate', 'news', 'viewer', 'outstand'));
    }
    ...
    public function detailBlog($slugParent, $slug)
    {
        ...
        return view('cntt.home.detailBlog', compact('cate', 'titleCate', 'news', 'sameCate'));
    }
}
