        ...
        <!-- <div class="col-xs-12">
            <div itemscope="" itemtype="https://schema.org/BreadcrumbList">
                <span itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
                    <a itemprop="item" href="https://cnttshop.vn/" title="Trang chủ">
                        <span itemprop="name">Trang chủ</span>
                    </a><meta itemprop="position" content="1">
                </span>&nbsp;»&nbsp;
                <span itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
                    <a itemscope="" itemtype="https://schema.org/WebPage" itemid="switch" itemprop="item" href="https://cnttshop.vn/switch" title="✅ Switch">
                        <span itemprop="name">✅ Switch</span>
                    </a><meta itemprop="position" content="2">
                </span>&nbsp;»&nbsp;
                <span itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
                    <a itemscope="" itemtype="https://schema.org/WebPage" itemid="phan-phoi-switch-cisco-1111" itemprop="item" href="https://cnttshop.vn/phan-phoi-switch-cisco-1111" title="✅ Switch Cisco">
                        <span itemprop="name">✅ Switch Cisco</span>
                    </a><meta itemprop="position" content="3">
                </span>&nbsp;»&nbsp;
                <span itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
                    <a itemscope="" itemtype="https://schema.org/WebPage" itemid="cisco-business-350-series" itemprop="item" href="https://cnttshop.vn/cisco-business-350-series" title="✅ Cisco CBS350">
                        <span itemprop="name">✅ Cisco CBS350</span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="content-des">
                            <h1>{{ $product->name }}</h1>
                            <div class="product-des" style="text-align: justify;">{!! $product->des !!}</div>
                            <div class="fk-main">
...
<section id="pr-detail">
    <div class="container">
        <div class="row">
            ...
            <!-- Hotline -->
            <div class="col-lg-3">
                <div class="support-prod new-prod mt-15">
